...
export const CHAR_ICON: Record<CharKey, string> = {
  СИЛ: "💪",
  СТА: "🛡️",
  СПР: "⚡",
  РОЗ: "📏",
...
export const CHAR_DESCRIPTIONS: Record<CharKey, string> = {
  СИЛ: "Фізична потужність — сила удару, наскільки важкі речі можна підняти чи зламати.",
  СТА: "Витривалість і здоров'я — стійкість тіла до травм і хвороб.",
  СПР: "Швидкість реакції та моторика — визначає порядок дій у бою.",
  РОЗ: "Зріст і вага персонажа.",
  ВОЛ: "Стійкість психіки — основа Глузду й опору магічним та психічним впливам.",
  ПРИ: "Харизма — яке враження персонаж справляє на інших.",
  ІНТ: "Кмітливість, здатність помічати деталі й робити висновки.",
  ОСВ: "Рівень знань і ерудиції, здобутий освітою й досвідом.",
};
